...
function ChatbotPage() {
  ...
  const handleSend = () => {
    ...
    setNewMsgIds(prev => new Set(prev).add(userId));

    setIsTyping(true);
    // nanti backend isi di sini
  };
  ...
  const renderBotBubble = (msg: Message) => {
    return (
      <div key={msg.id} className={`message-row bot ${newMsgIds.has(msg.id) ? "msg-float-in" : ""}`}>
          ...
          <div className="bot-bubble">
            ...
            {msg.file ? (
              <div className="file-attachment">
                ...
                <a href={msg.file.url} download={msg.file.name} className="file-attachment-btn">
                  ⬇ Download
                </a>
              </div>
            ) : null}
  ...
  const renderUserBubble = (msg: Message) => {
    return (
      <div key={msg.id} className={`message-row user ${newMsgIds.has(msg.id) ? "msg-float-in" : ""}`}>
        <div className="bubble-wrapper">
    ...
    <div className="chatbot-container">
      <div className="chat-header">
        ...
        <div className="header-text">
          ...
          <p className="header-subtitle">Tanya Apapun Seputar Akademik!</p>
        </div>
      ...
      <div className="chat-area">
        ...
        {messages.map((msg) => msg.role === "bot" ? renderBotBubble(msg) : renderUserBubble(msg))}
      ...
      <div className="input-area">
        ...
        />
        <button onClick={handleSend} className={sendAnim ? "plane-fly" : ""}>
          <FaPaperPlane />
        </button>
      </div>
    </div>
